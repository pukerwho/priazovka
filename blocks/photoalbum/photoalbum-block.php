<div class="mycard">
  ...
  <div class="text-side bg-success float-left d-flex justify-content-center align-items-center text-white flex-column">
    ...
    <div class="lead text-center py-3 px-3">Фотографии Арабатской стрелки 2019</div>
    <div><a href="/page-photoalbums" class="display-4 text-white border-bottom">Смотреть</a></div>
  </div>
</div>